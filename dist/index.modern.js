...
var ACLProvider = function ACLProvider(_ref) {
  ...
  return React.createElement(ACLContext.Provider, {
    value: {
      loading: loading,
...
var useACL = function useACL() {
  var context = useContext(ACLContext);
  return context;
};
...
export { ACLContext, ACLProvider, ACLService, useACL };
